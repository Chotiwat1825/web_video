...
console.log('--- [1/5] กำลังอัปเดตข้อมูลวิดีโอ Heedeng ---');
runCommand('python scrape_heedeng_update.py', 'scrape_heedeng');

// 2. แปลงเพลย์ลิสต์ Heedeng
console.log('--- [2/5] กำลังแปลงข้อมูลเพลย์ลิสต์ Heedeng ---');
runCommand('node convert_heedeng.js', '.');

// 3. อัปเดตข้อมูล Lovehee
console.log('--- [3/5] กำลังอัปเดตข้อมูลวิดีโอ Lovehee ---');
runCommand('python scrape_lovehee_update.py', 'scrape_lovehee');

// 4. แปลงเพลย์ลิสต์ Lovehee
console.log('--- [4/5] กำลังแปลงข้อมูลเพลย์ลิสต์ Lovehee ---');
runCommand('node convert_lovehee.js', '.');

// 5. รวบรวมและอัปเดตดัชนีเพลย์ลิสต์ทั้งหมด
console.log('--- [5/5] กำลังรวมเพลย์ลิสต์และสร้างดัชนีใหม่ ---');
